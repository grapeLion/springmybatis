package cn.ms.springbootmybatis;
...
//			rsaEncrypt.loadPublicKey(RSAEncrypt.DEFAULT_PUBLIC_KEY);
			rsaEncrypt.loadPublicKey(rsaEncrypt.getClass().getClassLoader().getResourceAsStream("rsa_public_key.pem"));
...
//			rsaEncrypt.loadPrivateKey(RSAEncrypt.DEFAULT_PRIVATE_KEY);
			rsaEncrypt.loadPrivateKey(rsaEncrypt.getClass().getClassLoader().getResourceAsStream("rsa_private_key.pem"));
